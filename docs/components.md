...
- `backgroundColor`: `none` (default) | `border` | same action colors as lights — a 10%-opacity wash of that color layered on top of the existing surface (spots + base stay unchanged)
